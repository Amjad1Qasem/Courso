            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage('assets/images/ins1.png'),
                          ),
                        ),
                      ),
                      const SizedBox(
                  ...
                  defText(
                      text: 'قيادة الحاسب ICDL',
                      size: 15,
                      fontWeight: FontWeight.w700,
                      color: const Color(0xff333333)),
                  defText(
                      text:
                          'احترف كل ما يخص مهارات الحاسب فى سوق العمل مجانا مثل  Word و Excel وغيرها لتصبح محترف واحصل على شهادة دولية في قيادة الحاسب.',
                      size: 15,
                  ...
                  Column(
                    children: [
                      Row(
                        children: [
                          const Image(
                            image: AssetImage('assets/images/MoneyIcon.png'),
                            width: 45,
                            height: 45,
                          ),
                          const SizedBox(
                      ...
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.only(start: 50, top: 5),
                        child: Row(
                          children: [
                            defText(
                                text: ' 50000 ل.س',
                  ...
                  Row(
                    children: [
                      const Image(
                        image: AssetImage('assets/images/teacherIcon.png'),
                        width: 45,
                        height: 45,
                      ),
                      const SizedBox(
                  ...
                  Row(
                    children: [
                      const Image(
                        image: AssetImage('assets/images/CourseTopics.png'),
                        width: 45,
                        height: 45,
                      ),
                      const SizedBox(
                  ...
                  Row(
                    children: [
                      ...
                      defText(
                          text: 'استخدام الحاسب الآلي (Widows 10)',
                          size: 15,
                          fontWeight: FontWeight.w400,
                          color: const Color(0xff333333))
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      defText(
                          text: 'مفاهيم أساسية عن تكنولوجيا المعلمومات (IT)',
                          size: 15,
                          fontWeight: FontWeight.w400,
                          color: const Color(0xff333333))
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      defText(
                          text: 'الاتصالات والمعلومات (Internet & E-Mail) ',
                          size: 15,
                          fontWeight: FontWeight.w400,
                          color: const Color(0xff333333))
                    ],
